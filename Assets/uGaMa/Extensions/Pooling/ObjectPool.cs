 ...
 */
    ...
    public class ObjectPool : IDisposable
    {
        ...
        private GameObject poolingTarget;
        ...
        /// <param name="obj">Game object for pooling target</param>
        ...
        public ObjectPool(GameObject obj, GameObject poolingTarget, int initialPoolSize, int maxPoolSize, bool willGrow)
        {
            Debug.Log("in the constructor");
            ...
            //store our other variables that are usefull.
            this.maxPoolSize = maxPoolSize;
            this.poolingTarget = poolingTarget;
            pooledObj = obj;
            this.initialPoolSize = initialPoolSize;
            this.willGrow = willGrow;
        }

        public ObjectPool(string resourcePath, GameObject poolingTarget, int initialPoolSize, int maxPoolSize,
            bool willGrow)
        {
        ...
        public GameObject GetObject()
        {
            ...
            if (willGrow || maxPoolSize > pooledObjects.Count)
            {
                ...
                pooledObjects.Add(nObj);
                //return the object to requestor.
                return nObj;
            }
        ...
        public void Shrink()
        {
            ...
            for (int i = pooledObjects.Count - 1; i >= initialPoolSize; i--)
            {
